...
# conf
# New in 3.3.0: Print details about server configuration.
# 17
...
# will respond with imok if it is running. Otherwise it will not respond at all.
...
# active and bound to the specified client port. Use "stat" for details
# on state wrt quorum and client connection information.
...
#   Latency***
#   No of Connections, Zookeeper id, mode (ie Leader or Follower) etc...
...
# **Can be used to identify if there is too many watches in Zookeeper
echo "wchs" | nc localhost 2181

#wchc
#New in 3.3.0: Lists detailed information on watches for the server,
# by session. This outputs a list of sessions(connections) with
# associated watches (paths). Note, depending on the number of
...
# ***Provides info about latecny, packets received, no of nodes??, no of watch etc...
