...
# Note: The stream that is created continuously process messages whose number can be
# identified in the section 'Local runtime statistics'
...
---- Second Check (Note the no of messages processed has increased)

...
Local runtime statistics
------------------------
messages-per-sec:      0.10   total-messages:       232     last-message: 2020-05-15T16:26:07.197Z
